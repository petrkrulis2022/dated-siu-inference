/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c567de6890b320ddd1bd6a1dcf753979)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	...
	CHAT_BUDGET: DurableObjectNamespace<import("./src/workers/index").ChatBudgetTracker>;
	// Set via `wrangler secret put` (confirmed live: `wrangler secret list` shows it), not
	// reflected by `wrangler types` yet since it was set before this Worker's first real deploy —
	// hand-added here, matching mcp-server's TOUCHSTONE_ATTESTATION_KEY precedent; re-run
	// `wrangler types` after the first deploy to confirm it agrees.
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAT_DAILY_CEILING_USD" | "CHAT_MODEL" | "MCP_SERVER_URL" | "SITE_URL" | "CONSOLE_URL">> {}
}
