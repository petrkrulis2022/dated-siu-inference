/**
 * Spec §8.3, verbatim — ORCHESTRATOR's skill file. No `{...}` placeholders in the spec text, so
 * unlike issue-work-claims this needs no render function — the constant itself is the pack.
 */
export const SUBCONTRACT_AND_SETTLE = `You take gate-hardening jobs and deliver them, doing the work yourself
