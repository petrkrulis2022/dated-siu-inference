/**
 * Spec §8.4, verbatim — WORKER-CODE/WORKER-EXTRACT's skill file. No `{...}` placeholders, same
 * reasoning as subcontract-and-settle.ts.
 */
export const QUOTE_AND_DELIVER = `You sell work. You have two roles depending on what you are asked for.
