/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e2e4733d45a4e30bc105e0e1a5fdfdcd)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	PRINTS_CACHE: KVNamespace;
	...
	TOUCHSTONE_ATTESTATION_KEY: string;
	TOUCHSTONE_MCP: DurableObjectNamespace<import("./src/workers/index").TouchstoneMcpAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/index");
		durableNamespaces: "TouchstoneMcpAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOUCHSTONE_SELLER_ADDRESS" | "TOUCHSTONE_CHAIN_NAME" | "TOUCHSTONE_ESCROW_ADDRESS" | "BASE_SEPOLIA_RPC_URL" | "TOUCHSTONE_ATTESTATION_KEY">> {}
}
