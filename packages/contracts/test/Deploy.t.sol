...
contract DeployTest is Test {
    ...
    function setUp() public {
        script = new Deploy();
        vm.setEnv("DATUM_PUBLISHER_ADDRESS", "0x0000000000000000000000000000000000000A11");
        vm.setEnv("DATUM_TREASURY", "0x0000000000000000000000000000000000000B22");
        vm.setEnv("DATUM_FEE_BPS", "50");
    }
    ...
    // Deliberately no test here that sets DATUM_FEE_BPS above the cap and re-runs the script.
    ...
    // ceiling is a DatumEscrow constructor property and is covered exhaustively there by
